...
`functional-parity.test.js` alone is **not sufficient**: it mostly builds Frozen via internal MiniSearch/snapshot import helpers and compares Frozen-vs-Frozen on `fromDocuments`. Native indexing must be checked against upstream.
